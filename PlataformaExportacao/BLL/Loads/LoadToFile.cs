...
using PlataformaExportacao.Utils;
...
namespace PlataformaExportacao.BLL
{
    public class LoadToFile : LoadBase
    {
        ...
        {
            FileStream file = new FileStream(Processing.OutputFileFolderPath + "\\" + Processing.OutputFileName + processing.OutputFileExtension, FileMode.Create);
            return file;
        }
